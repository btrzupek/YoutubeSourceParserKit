...
public extension NSURL {
  ...
  */
  func dictionaryForQueryString() -> [String: AnyObject]? {
    ...
    let result = (absoluteString! as NSString).components(separatedBy: "?")
    if result.count > 1 {
...
public extension NSString {
  ...
  */
  func stringByDecodingURLFormat() -> String {
    let result = self.replacingOccurrences(of: "+", with:" ") as NSString
...
public class Youtube: NSObject {
  ...
  public static func youtubeIDFromYoutubeURL(youtubeURL: NSURL) -> String? {
    if let
      youtubeHost = youtubeURL.host,
        ...
        let youtubeAbsoluteString = youtubeURL.absoluteString! as NSString
        if youtubeHost == "youtu.be" as String? {
          return youtubePathComponents[1]
        } else if (youtubeAbsoluteString as String).range(of: "www.youtube.com/embed") != nil {
  ...
  */
  public static func h264videosWithYoutubeURL(youtubeURL: NSURL,completion: ((
    ...
    dispatch_get_global_queue(priority, 0).async() {
